...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::git::git_browse_url,
            commands::git::git_browse_template,
            ...
            commands::jira::jira_get_settings,
            commands::jira::jira_set_settings,
            commands::jira::jira_set_token,
            commands::jira::jira_has_token,
